...
<div id="main">
	...
	<div class="main_Container">
		...
		for(int j=0;j<browserName.length;j++)
		    ...
		    <h4 align="left" ><font color="black">To view results of <em style="color: green"><%=browserName[j].toUpperCase()%></em> browser. <a href="test-output/<%=browserName[j].toUpperCase()%>/html/index.html"><font color="red">Click Here</font></a></font></h4>
			<h4 align="left" ><font color="black">To view Graphic results of <em style="color: green"><%=browserName[j].toUpperCase()%></em> browser. <a href="test-output/<%=browserName[j].toUpperCase()%>/GraphReporting/index.html"><font color="red">Click Here</font></a></font></h4>
			<h4 align="left" ><font color="black">To download the result as zip file. <a href="Results_<%=browserName[j].toUpperCase()+"_"+getServletContext().getAttribute("date").toString()%>.zip"><font color="red">Click Here</font></a></font></h4>
		</div>
		<% }%>
		 </div>
	</div>
