...
public class TS_32_Verify_ContentEditorPage_StudentFinancesHouseholdInformationLink {
	...
	public void TC_03_Validate_PopUps_DefaultContent() {
		...
		List<WebElement> viewDefaultList=contentEditorPage.viewDefaultList; 
		 Iterator<WebElement> i = viewDefaultList.iterator(); 
		 while(i.hasNext()) { 
