...
public class TS_50_Verify_Packaging_Parent_Contribution {
...
//	EditPackaging_ParentContribution editPackaging = null;
	...
	public void TC_01_Validate_Assignment_Table() {
		...
		String expected="Parent Contribution";		
		String actual=co.getText(packagingPage.pageTitle,"extracting text from the sub Header in  Contribution page.");
		...
		Assert.assertEquals(actual, expected,"page did not navigated to the  Edit Packaging Parent Contribution page.");
	}
	...
	public void TC_02_Validate_Fixed_Link() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.fixedLink,"clicking on fixed link present in the Edit  Parent Contribution page.");
	...
	public void TC_03_Validate_Save_Button() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.fixedLink,"clicking on fixed link present in the Edit Packaging Parent Contribution page.");
		String testData=cm.randomNumberGenerator();
		
		co.type(packagingPage.editPackageInputField,testData,"Entering some values into the text field in Edit Packaging Parent Contribution page.");
		co.click(packagingPage.editPackageSaveButton,"clicking the save button in Edit Packaging Parent Contribution page.");
		co.alertHandler(driver).accept();
		packagingPage= new PackagingPage().packagingPageElementsInit(driver);
		co.click(packagingPage.parentContributionLink,"clicking on parent contribution link.");
		//String actual=co.getText(packagingPage.editPackageInputField,"Extracting value from the text field in Edit Packaging Parent Contribution page.");
	...
	public void TC_04_Validate_Cancel_Button() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.editPackageCancelButton,"clicking on cancel button present in parent contribution page.");
		packagingPage= new PackagingPage().packagingPageElementsInit(driver);
	...
	public void TC_05_Validate_Factor_Link() {
		...
		co.click(packagingPage.factorLink,"clicking on Add Factor of link present in the Edit Packaging Parent Contribution page.");
	...
	public void TC_06_Validate_ValueTable_Link() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.ValueTableLink,"clicking on Value From Table link present in the Edit Packaging Parent Contribution page.");
